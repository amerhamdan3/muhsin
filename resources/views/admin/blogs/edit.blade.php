...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.blogs.update", [$blog->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="main">{{ trans('cruds.blog.fields.main') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('main') ? 'is-invalid' : '' }}" name="main" id="main">{!! old('main', $blog->main) !!}</textarea>
                @if($errors->has('main'))
                    <div class="invalid-feedback">
                        {{ $errors->first('main') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.blog.fields.main_helper') }}</span>
            </div>
            <div class="form-group">
