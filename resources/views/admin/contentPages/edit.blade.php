    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.content-pages.update", [$contentPage->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $contentPage->description) !!}</textarea>
            ...
            <div class="form-group">
                <label for="videos">{{ trans('cruds.contentPage.fields.videos') }}</label>
                <textarea class="form-control {{ $errors->has('videos') ? 'is-invalid' : '' }}" name="videos" id="videos">{{ old('videos', $contentPage->videos) }}</textarea>
                @if($errors->has('videos'))
                    <div class="invalid-feedback">
                        {{ $errors->first('videos') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.contentPage.fields.videos_helper') }}</span>
            </div>
            <div class="form-group">
